          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                ...
                <p>
                  <a href="https://rohitgupta.design/oneshopper-gatsby-site" target="_blank" rel="noopener noreferrer">
                ...
                <ul>
                  ...
                  <li>
                    Store page with all Product with few good features like Rating, Price, Checkout, More then one
